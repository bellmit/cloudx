 ...
 */
@Component
public class StandardExceptionResolver extends MappingExceptionResolver<HttpServletRequest, HttpServletResponse> {
    ...
    class DefaultExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        ...
        @Override
        public Object resloveException(HttpServletRequest request, HttpServletResponse response, Throwable throwable) {
            return StandardResult.error(Errno.ERROR);
        }
    }

    class IllegalArgumentExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class ReadOnlyExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class NoHandlerFoundExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class StandardResultExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class UnsupportedOperationExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class BlockExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class FlowBlockExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class FuseBlockExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class LimitKeyExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
