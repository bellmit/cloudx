...
public class GlobalAccessDirective extends PreAccessDirective {
    public static final String GLOBAL_ACCESS_NAME = "__global";
    ...
    public void parse(Block block, GatewayConfig config) throws ConfigParseException {
        ...
        for (Block interceptorBlock : interceptorList) {
            ...
            config.addInterceptor(GLOBAL_ACCESS_NAME, interceptor);
        }
    }
}
