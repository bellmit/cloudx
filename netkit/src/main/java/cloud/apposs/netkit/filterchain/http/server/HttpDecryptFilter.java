...
public class HttpDecryptFilter extends IoFilterAdaptor {
    ...
    public HttpDecryptFilter() {
        this(HttpConstants.DEFAULT_CHARSET, HttpConstants.DEFAULT_TMP_DIRECTORY, HttpConstants.DEFAULT_MAX_FILE_SIZE);
    }

    public HttpDecryptFilter(String charset) {
        this(charset, HttpConstants.DEFAULT_TMP_DIRECTORY, HttpConstants.DEFAULT_MAX_FILE_SIZE);
    }

    public HttpDecryptFilter(String charset, String directory, long maxSize) {
        SysUtil.checkNotNull(charset, "charset");
        this.charset = charset;
        this.threshold = HttpConstants.DEFAULT_FILE_LIMIT;
    ...
    public final class Context {
        ...
        private FormDecrypt doCreateFormDecrypt(
            ...
            if (MediaType.MULTIPART_FORM_DATA.matchType(contentType)) {
                return new FormDataDectypt(contentType, charset, bufferSize, threshold, directory, maxSize);
            }
