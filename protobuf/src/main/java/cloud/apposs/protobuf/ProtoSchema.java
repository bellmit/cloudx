...
public class ProtoSchema implements Serializable {
	 ...
	 * @return {@link ProtoSchema}
	 */
	public static ProtoSchema getSchema(List<?> list, Class<?> fieldType) {
		...
		schema.add(0, null, codec, fieldSchema);
		return schema;
	}
	 ...
	 * @return {@link ProtoSchema}
	 */
	public static ProtoSchema getSchema(List<?> list, Class<?> fieldType, ProtoSchema fieldSchema) {
		SysUtil.checkNotNull(list, "list");
		SysUtil.checkNotNull(fieldType, "fieldType");
