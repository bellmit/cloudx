...
public final class DateUtil {
    ...
    public static Date getHourBegin() {
        return DateUtil.getHourBegin(DateUtil.getCurrentDate());
    }
    ...
    public static Date getHourEnd() {
        return DateUtil.getHourEnd(DateUtil.getCurrentDate());
    }
    ...
    public static Date getWeekEnd(Date date) {
        ...
        int dayOfWeek = calendar.get(Calendar.DAY_OF_WEEK);
        calendar.add(Calendar.DAY_OF_MONTH, -dayOfWeek);
        calendar.add(Calendar.DAY_OF_MONTH, Calendar.SATURDAY);
        calendar.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
                calendar.get(Calendar.DAY_OF_MONTH) + 1, 0, 0, 0);
        calendar.set(Calendar.SECOND, calendar.get(Calendar.SECOND) - 1);
        calendar.set(Calendar.MILLISECOND, 0);
     ...
     * 获取当前日期所在季度的开始日期
     *
     * @return 当前日期所在季度的开始日期
     */
    public static Date getQuarterBegin() {
        return DateUtil.getQuarterBegin(DateUtil.getCurrentDate());
    }
     ...
     * 获取当前日期所在季度的结束日期
     *
     * @return 当前日期所在季度的结束日期
     */
    public static Date getQuarterEnd() {
        return DateUtil.getQuarterEnd(DateUtil.getCurrentDate());
    }
    ...
    public static int getDaysOfMonth() {
        return DateUtil.getDaysOfMonth(DateUtil.getCurrentDate());
    }
